...
public class Activator extends GenericBundleActivator {
    ...
    private final GraphqlCorsWebInterceptor graphqlCorsWebInterceptor= new GraphqlCorsWebInterceptor();
    ...
    public void start(BundleContext context) throws Exception {
        ...
        System.out.println("Installing the graphqlCorsWebInterceptor");
